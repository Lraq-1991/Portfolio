...
<table border="1" class="dataframe table table-striped">
  ...
  {
    tittle: "Inventory Risk Analysis and Sales Trend",
    query_text: `
        <div style="color: #7a7a7a;">/*
            <div style="margin-left: 3rem;">
                Challenge: Identify products that are at high risk of stock depletion.<br><br> 

                To do this, you must find products whose sales volume in the last 30 days<br> 
                is at least 20% higher than their average daily sales in the previous 90 days.<br> 
                The query should list the product name, total sales volume over the last 30 days,<br> 
                and average daily sales over the previous 90 days.<br> 
            </div>
        */</div><br>

        <div style="color: #7a7a7a;">-- USE AdventureWorks2022</div><br>

        <div style="color: #0080ff; font-weight: bold;">WITH</div> 
<div>
    sales_CTE <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;">-- Get ranked product sales count per month per product</span>
</div>
<div style="margin-left: 2rem;">
    <span style="color: #0080ff; font-weight: bold;">SELECT</span> 
    <div style="margin-left: 2rem;">
        <ul>
            <li>pp.Name prod_name,</li>
            <li><span style="color: #6b1cf3;">FORMAT</span>(soh.OrderDate, <span style="color: #a5d6ff;">'yyyy, MMMM'</span>) order_date, <span style="color: #7a7a7a;">-- Cast to month per year</span></li>
            <li><span style="color: #6b1cf3;">COUNT</span>(sod.ProductID) sold, <span style="color: #7a7a7a;">-- Get how much I sold of that product</span></li>
            <li><span style="color: #6b1cf3;">ROW_NUMBER</span>() <span style="color: #0080ff; font-weight: bold;">OVER</span>( <span style="color: #7a7a7a;">-- Create ranking per product and ordered by month</span>
                <div style="margin-left: 2rem;">
                    <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> pp.Name<br>
                    <span style="color: #0080ff; font-weight: bold;">ORDER BY</span> <span style="color: #6b1cf3;">FORMAT</span>(soh.OrderDate, <span style="color: #a5d6ff;">'yyyy, MMMM'</span>) <span style="color: #0080ff; font-weight: bold;">DESC</span>
                </div>
            ) <span style="color: #0080ff; font-weight: bold;">AS</span> month_rank</li>
        </ul>
    </div>
    <div>
        <span style="color: #0080ff; font-weight: bold;">FROM</span> Sales.SalesOrderHeader soh
    </div>
    <div>
        <span style="color: #0080ff; font-weight: bold;">JOIN</span> Sales.SalesOrderDetail sod
    </div>
    <div style="margin-left: 2rem;">
        <span style="color: #0080ff; font-weight: bold;">ON</span> soh.SalesOrderID = sod.SalesOrderID
    </div>
    <div>
        <span style="color: #0080ff; font-weight: bold;">JOIN</span> Production.Product pp
    </div>
    <div style="margin-left: 2rem;">
        <span style="color: #0080ff; font-weight: bold;">ON</span> sod.ProductID = pp.ProductID
    </div>
    <div style="color: #0080ff; font-weight: bold;">GROUP BY</div>
    <ul style="margin-left: 2rem;">
        <li>pp.Name,</li>
        <li><span style="color: #6b1cf3;">FORMAT</span>(soh.OrderDate, <span style="color: #a5d6ff;">'yyyy, MMMM'</span>)</li>
    </ul>
</div>
), last_month_CTE <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;">-- Get last month sales per product</span>
    <div style="margin-left: 2rem;">
        <div style="color: #0080ff; font-weight: bold;">SELECT</div>
        <ul style="margin-left: 2rem;">
            <li>prod_name,</li>
            <li>sold last_month_sale</li>
        </ul>
        <span style="color: #0080ff; font-weight: bold;">FROM</span> sales_CTE<br>
        <span style="color: #0080ff; font-weight: bold;">WHERE</span> month_rank = 1 <span style="color: #7a7a7a;">-- Filter just last month sales</span>
    </div>
), last_quarter_sale_CTE <span style="color: #0080ff; font-weight: bold;">AS</span>(
    <div style="margin-left: 2rem;">
        <div style="color: #0080ff; font-weight: bold;">SELECT</div>
        <ul style="margin-left: 2rem;">
            <li>prod_name,</li>
            <li><span style="color: #6b1cf3;">SUM</span>(sold)/90.0 avg_sales <span style="color: #7a7a7a;">-- Avg sales for the last 3 quarter, convert to float</span></li>
        </ul>
        <span style="color: #0080ff; font-weight: bold;">FROM</span> sales_CTE<br>
        <span style="color: #0080ff; font-weight: bold;">WHERE</span> month_rank <= 3<br>
        <div style="color: #0080ff; font-weight: bold;">GROUP BY</div>
        <ul style="margin-left: 2rem;">
            <li>prod_name</li>
        </ul>
...
<div style="color: #0080ff; font-weight: bold;">SELECT</div>
<div style="margin-left: 2rem;">
    <div>cte1.prod_name <span style="color: #a5d6ff;">'Product Name'</span>,</div>
    <div>cte1.last_month_sale <span style="color: #a5d6ff;">'Last Month Sales'</span>,</div>
    <div>cte2.avg_sales <span style="color: #a5d6ff;">'Avg. Sales Last Quarter'</span>,</div>
    <div>((cte1.last_month_sale - (cte2.avg_sales * 30)) / (cte2.avg_sales * 30)) * 100 <span style="color: #a5d6ff;">'Sales Growth (%)'</span> <span style="color: #7a7a7a;">-- Get growth for the past month</span></div>
</div>
<span style="color: #0080ff; font-weight: bold;">FROM</span> last_month_CTE cte1
<div>
    <span style="color: #0080ff; font-weight: bold;">JOIN</span> last_quarter_sale_CTE cte2
</div>
<div style="margin-left: 2rem;">
    <span style="color: #0080ff; font-weight: bold;">ON</span> cte1.prod_name = cte2.prod_name
</div>
<span style="color: #0080ff; font-weight: bold;">ORDER BY</span> [Sales Growth (%)] <span style="color: #0080ff; font-weight: bold;">DESC</span>;
  ...
  <tbody>
    ...
    <tr>
      <td>HL Touring Frame - Yellow, 54</td>
      <td>23</td>
      <td>0.600000</td>
      <td>27.777778</td>
    </tr>
    ...
    <tr>
      <td>LL Touring Frame - Yellow, 62</td>
      <td>20</td>
      <td>0.522222</td>
      <td>27.659629</td>
    </tr>
    ...
    <tr>
      <td>HL Touring Frame - Blue, 54</td>
      <td>21</td>
      <td>0.577777</td>
      <td>21.154009</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Silver, 52</td>
      <td>16</td>
      <td>0.488888</td>
      <td>9.091107</td>
    </tr>
    ...
    <tr>
      <td>HL Touring Frame - Blue, 50</td>
      <td>9</td>
      <td>0.288888</td>
      <td>3.846473</td>
    </tr>
    ...
    <tr>
      <td>HL Mountain Frame - Black, 44</td>
      <td>2</td>
      <td>0.066666</td>
      <td>0.001000</td>
    </tr>
    <tr>
      <td>LL Mountain Frame - Silver, 40</td>
      <td>17</td>
      <td>0.566666</td>
      <td>0.000118</td>
    </tr>
    ...
    <tr>
      <td>ML Road Frame-W - Yellow, 48</td>
      <td>17</td>
      <td>0.633333</td>
      <td>-10.526269</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Black, 42</td>
      <td>12</td>
      <td>0.455555</td>
      <td>-12.195015</td>
    </tr>
    ...
    <tr>
      <td>LL Touring Frame - Blue, 54</td>
      <td>9</td>
      <td>0.355555</td>
      <td>-15.624868</td>
    </tr>
    ...
    <tr>
      <td>HL Touring Frame - Blue, 46</td>
      <td>7</td>
      <td>0.277777</td>
      <td>-15.999765</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Black, 44</td>
      <td>22</td>
      <td>0.877777</td>
      <td>-16.455622</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Silver, 44</td>
      <td>20</td>
      <td>0.811111</td>
      <td>-17.808208</td>
    </tr>
    <tr>
      <td>LL Mountain Frame - Black, 48</td>
      <td>21</td>
      <td>0.855555</td>
      <td>-18.181765</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Silver, 42</td>
      <td>20</td>
      <td>0.922222</td>
      <td>-27.710826</td>
    </tr>
    ...
    <tr>
      <td>HL Touring Frame - Yellow, 46</td>
      <td>4</td>
      <td>0.188888</td>
      <td>-29.411433</td>
    </tr>
    ...
    <tr>
      <td>LL Touring Frame - Yellow, 44</td>
      <td>8</td>
      <td>0.422222</td>
      <td>-36.842072</td>
    </tr>
    ...
    <tr>
      <td>LL Mountain Frame - Silver, 48</td>
      <td>3</td>
      <td>0.177777</td>
      <td>-43.749754</td>
    </tr>
    ...
    <tr>
      <td>HL Touring Frame - Yellow, 50</td>
      <td>1</td>
      <td>0.166666</td>
      <td>-79.999920</td>
    </tr>
    ...
    <tr>
      <td>LL Road Frame - Red, 62</td>
      <td>1</td>
      <td>0.288888</td>
      <td>-88.461503</td>
    </tr>
    <tr>
      <td>LL Road Frame - Red, 48</td>
      <td>1</td>
      <td>0.300000</td>
      <td>-88.888889</td>
    </tr>
  ...
  {
    tittle: "Customer Behavioral Sequence Analysis",
    query_text: `
        <div style="color: #7a7a7a;">/*
            <div style="margin-left: 3rem;">
                The Challenge: Calculate number of customers per distinct purchase sequence.<br><br> 

                Identify customers who, in their first three purchase transactions,<br> 
                bought products from a different product category each time.<br> 
                Segment these customers into groups based on the specific sequence of their first three category purchases<br> 
                (e.g., 'Bikes -> Components -> Clothing').<br> 
                The final result should show each unique purchasing sequence and the number of customers who followed that sequence.<br>
            </div>
        */</div><br>
        ...
        <div style="color: #0080ff; font-weight: bold;">WITH</div> 
            <div>
                cx_list <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;"> -- Ranking customer´s purchases</span> 
            </div>
            <div style="margin-left: 2rem;">
                <span style="color: #0080ff; font-weight: bold;">SELECT</span> 
                <div style="margin-left: 2rem;">
                    <ul>
                        <li>soh.CustomerID customer,</li> 
                        <li>pc.Name category,</li> 
                        <li><span style="color: #6b1cf3;">ROW_NUMBER</span>() <span style="color: #0080ff; font-weight: bold;">OVER</span>(</li> 
                            <div style="margin-left: 2rem;">
                                <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> soh.CustomerID<br> 
                                <span style="color: #0080ff; font-weight: bold;">ORDER BY</span> soh.SalesOrderID 
                            </div>
                        ) <span style="color: #0080ff; font-weight: bold;">AS</span> order_rank</li> 
                    </ul>
                </div>
                <div>
                    <span style="color: #0080ff; font-weight: bold;">FROM</span> Sales.SalesOrderHeader soh 
                ...
                <div>
                    <span style="color: #0080ff; font-weight: bold;">JOIN</span> Production.ProductSubcategory psc 
                </div>
                <div style="margin-left: 2rem;">
                    <span style="color: #0080ff; font-weight: bold;">ON</span> pp.ProductSubcategoryID = psc.ProductSubcategoryID 
                </div>
                <div>
                    <span style="color: #0080ff; font-weight: bold;">JOIN</span> Production.ProductCategory pc 
                </div>
                <div style="margin-left: 2rem;">
                    <span style="color: #0080ff; font-weight: bold;">ON</span> psc.ProductCategoryID = pc.ProductCategoryID 
                </div>
            </div>
            ), filtered_table <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;"> -- getting first 3 purchases per cx</span> 
                <div style="margin-left: 2rem;">
                    <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
                    <ul style="margin-left: 2rem;">
                        <li>*</li> 
                    </ul>
                    <span style="color: #0080ff; font-weight: bold;">WHERE</span> order_rank <= 3 
                </div>
            ), sequence_CTE <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;"> -- Creating the matrix of categories per customer</span> 
                <div style="margin-left: 2rem;">
                    <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
                    <ul style="margin-left: 2rem;">
                        <li>customer,</li> 
                        <li>[1] <span style="color: #0080ff; font-weight: bold;">AS</span> first_purchase,</li> 
                        <li>[2] <span style="color: #0080ff; font-weight: bold;">AS</span> second_purchase,</li> 
                        <li>[3] <span style="color: #0080ff; font-weight: bold;">AS</span> third_purchase</li> 
                    </ul>
                    <span style="color: #0080ff; font-weight: bold;">FROM</span> filtered_table <span style="color: #0080ff; font-weight: bold;">AS</span> SourceTable<br> 
                    <div style="color: #0080ff; font-weight: bold;">PIVOT</div>( 
                        <div style="margin-left: 2rem;">
                            <span style="color: #6b1cf3;">MAX</span>(category) <span style="color: #0080ff; font-weight: bold;">FOR</span> order_rank 
                            <div>
                                <span style="color: #0080ff; font-weight: bold;">IN</span> ([1],[2],[3]) 
                            </div>
                        </div>
                    ) <span style="color: #0080ff; font-weight: bold;">AS</span> pivotedTable 
                </div>
            )
            <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
            <div style="margin-left: 2rem;">
                <div>first_purchase + <span style="color: #a5d6ff;">' -> '</span> + second_purchase + <span style="color: #a5d6ff;">' -> '</span> + third_purchase <span style="color: #a5d6ff;">'Purchase Sequence'</span>, <span style="color: #7a7a7a;"> -- Formating for a cleaner presentation</span></div> 
                <div><span style="color: #6b1cf3;">COUNT</span>(customer) <span style="color: #a5d6ff;">'Customers Count'</span></div> 
            </div>
            <span style="color: #0080ff; font-weight: bold;">FROM</span> sequence_CTE 
            <div>
                <span style="color: #0080ff; font-weight: bold;">WHERE</span> <span style="color: #7a7a7a;"> -- Showing just distinct combinations</span> 
            </div>
            <div style="margin-left: 2rem;">
                <div>first_purchase != second_purchase</div> 
                <div><span style="color: #0080ff; font-weight: bold;">&emsp;&emsp;AND</span> second_purchase != third_purchase</div> 
                <div><span style="color: #0080ff; font-weight: bold;">&emsp;&emsp;AND</span> first_purchase != third_purchase</div> 
            </div>
            <div style="color: #0080ff; font-weight: bold;">GROUP BY</div> 
            <div style="margin-left: 2rem;">
                <div>first_purchase,</div> 
                <div>second_purchase,</div> 
                <div>third_purchase</div> 
            </div>
...
<table border="1" class="dataframe table table-striped">
  <thead>
    <tr style="text-align: left; margin-left: 1rem; margin-right: 10px;">
      <th>Purchase Sequence</th>
      <th>Customers Count</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Bikes -&gt; Clothing -&gt; Accessories</td>
      <td>281</td>
    </tr>
    <tr>
      <td>Bikes -&gt; Accessories -&gt; Clothing</td>
      <td>200</td>
    </tr>
    <tr>
      <td>Accessories -&gt; Clothing -&gt; Bikes</td>
      <td>99</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Accessories -&gt; Bikes</td>
      <td>58</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Bikes -&gt; Accessories</td>
      <td>55</td>
    </tr>
    <tr>
      <td>Accessories -&gt; Bikes -&gt; Clothing</td>
      <td>29</td>
    </tr>
    <tr>
      <td>Components -&gt; Bikes -&gt; Clothing</td>
      <td>7</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Bikes -&gt; Components</td>
      <td>5</td>
    </tr>
    <tr>
      <td>Bikes -&gt; Components -&gt; Clothing</td>
      <td>4</td>
    </tr>
    <tr>
      <td>Components -&gt; Clothing -&gt; Accessories</td>
      <td>3</td>
    </tr>
    <tr>
      <td>Accessories -&gt; Clothing -&gt; Components</td>
      <td>2</td>
    </tr>
    <tr>
      <td>Bikes -&gt; Accessories -&gt; Components</td>
      <td>2</td>
    </tr>
    <tr>
      <td>Bikes -&gt; Clothing -&gt; Components</td>
      <td>1</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Accessories -&gt; Components</td>
      <td>1</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Components -&gt; Accessories</td>
      <td>1</td>
    </tr>
    <tr>
      <td>Clothing -&gt; Components -&gt; Bikes</td>
      <td>1</td>
    </tr>
  </tbody>
</table>
  ...
  {
    tittle: "Management Hierarchy & Salary Gap Analysis",
    query_text: `
        <div style="color: #7a7a7a;">/*
            <div style="margin-left: 3rem;">
                The Challenge: Identify the organizational depth of every employee and compare their salary to the average salary of their specific management branch.<br><br> 

                Construct a full organizational hierarchy (who reports to whom) starting from the CEO.<br> 
                Calculate the "Hierarchy Level" (e.g., Level 0 for CEO, Level 1 for Direct Reports).<br> 
                For each employee, calculate the average Rate (salary) of all employees that fall under the same manager.<br> 
                Show the percentage difference between the employee's rate and the branch average.<br> 
            </div>
        */</div><br>
        ...
        <div style="color: #0080ff; font-weight: bold;">WITH</div> 
        <div>
            CTE <span style="color: #0080ff; font-weight: bold;">AS</span> ( <span style="color: #7a7a7a;"> -- Join emp with job history and order last pay value to be filtered later</span> 
        </div>
        <div style="margin-left: 2rem;">
            <span style="color: #0080ff; font-weight: bold;">SELECT</span>  
            <div style="margin-left: 2rem;">
                <ul>
                    <li>e.BusinessEntityID,</li>
                    <li>e.LoginID,</li>
                    <li>e.JobTitle,</li>
                    <li>e.OrganizationLevel,</li>
                    <li>e.OrganizationNode,</li>
                    <li>e.OrganizationNode.GetAncestor(1) Branch,</li>
                    <li>ep.Rate,</li>
                    <li>ep.ModifiedDate,</li>
                    <li><span style="color: #6b1cf3;">ROW_NUMBER</span>() <span style="color: #0080ff; font-weight: bold;">OVER</span>(
                        <div style="margin-left: 2rem;">
                            <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> e.BusinessEntityID<br>
                            <span style="color: #0080ff; font-weight: bold;">ORDER BY</span> ep.ModifiedDate <span style="color: #0080ff; font-weight: bold;">DESC</span>
                        </div>
                    ) Seniority</li>
                </ul>
            </div>
            <div>
                <span style="color: #0080ff; font-weight: bold;">FROM</span> HumanResources.Employee e
            </div>
            <div>
                <span style="color: #0080ff; font-weight: bold;">LEFT JOIN</span> HumanResources.EmployeePayHistory ep
            </div>
            <div style="margin-left: 2rem;">
                <span style="color: #0080ff; font-weight: bold;">ON</span> ep.BusinessEntityID = e.BusinessEntityID
            </div>
        </div>
        ), CTE2 <span style="color: #0080ff; font-weight: bold;">AS</span>(
            <div style="margin-left: 2rem;">
                <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
                <ul style="margin-left: 2rem;">
                    <li>*,</li>
                    <li><span style="color: #6b1cf3;">AVG</span>(Rate) <span style="color: #0080ff; font-weight: bold;">OVER</span>(
                        <div style="margin-left: 2rem;">
                            <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> Branch
                        </div>
                    ) BranchAvgRate</li> 
                </ul>
                <span style="color: #0080ff; font-weight: bold;">FROM</span> CTE<br>
                <span style="color: #0080ff; font-weight: bold;">WHERE</span> Seniority = 1
            </div>
        )
        <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
        <div style="margin-left: 2rem;">
            <div>c.BusinessEntityID,</div>
            <div><span style="color: #6b1cf3;">ISNULL</span>(c.OrganizationLevel, 0) OrganizationLevel, <span style="color: #7a7a7a;">-- Replacing NULL with for CEO</span></div>
            <div>p.LastName + <span style="color: #a5d6ff;">', '</span> + p.FirstName Employee,</div>
            <div>c.JobTitle,</div>
            <div>c.Rate,</div>
            <div>c.BranchAvgRate,</div>
            <div>( ( Rate / BranchAvgRate ) * 100 ) -100 <span style="color: #a5d6ff;">"RateGap (%)"</span></div>
        </div>
        <span style="color: #0080ff; font-weight: bold;">FROM</span> CTE2 c
        <div>
            <span style="color: #0080ff; font-weight: bold;">JOIN</span> Person.Person p
        </div>
        <div style="margin-left: 2rem;">
            <span style="color: #0080ff; font-weight: bold;">ON</span> c.BusinessEntityID = p.BusinessEntityID
        </div>
  ...
  <tbody>
    ...
    <tr>
      <td>22</td>
      <td>2</td>
      <td>Harnpadoungsataya, Sariya</td>
      <td>Marketing Specialist</td>
      <td>14.4231</td>
      <td>14.0625</td>
      <td>2.56</td>
    ...
    <tr>
      <td>290</td>
      <td>3</td>
      <td>Varkey Chudukatil, Ranjit</td>
      <td>Sales Representative</td>
      <td>23.0769</td>
      <td>23.0769</td>
      <td>0.00</td>
  ...
  {
    tittle: "Sales Performance Momentum Analysis",
    query_text: `
        <div style="color: #7a7a7a;">/*
            <div style="margin-left: 3rem;">
                The Challenge: Identify "consistent winners" among Sales People. <br><br> 

                For each salesperson, calculate their total sales for each month in 2013.<br> 
                Then, determine the Month-over-Month (MoM) percentage growth.<br> 
                Finally, filter the list to show only those salespeople who had a positive growth rate<br> 
                for at least three consecutive months.<br> 
            </div>
        */</div><br>
        ...
        <div style="color: #0080ff; font-weight: bold;">WITH</div> 
        <div>
            cte1 <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;">-- Extract Year and Month from orderdate column</span>
        </div>
        <div style="margin-left: 2rem;">
            <span style="color: #0080ff; font-weight: bold;">SELECT</span> 
            <div style="margin-left: 2rem;">
                <ul>
                    <li><span style="color: #6b1cf3;">YEAR</span>(OrderDate) SalesYear,</li>
                    <li><span style="color: #6b1cf3;">MONTH</span>(OrderDate) MonthNumber, <span style="color: #7a7a7a;">-- This will be used to order months in the following CTEs</span></li>
                    <li>SalesPersonID,</li>
                    <li>TotalDue</li>
                </ul>
            </div>
        ...
        ), cte2 <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;">-- Total sales per month per salesperson</span>
            <div style="margin-left: 2rem;">
                <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
                <ul style="margin-left: 2rem;">
                    <li>cte1.SalesPersonID,</li>
                    <li>cte1.MonthNumber,</li>
                    <li><span style="color: #6b1cf3;">SUM</span>(cte1.TotalDue) MonthProduction</li> 
                </ul>
                <span style="color: #0080ff; font-weight: bold;">FROM</span> cte1<br>
                <span style="color: #0080ff; font-weight: bold;">WHERE</span> SalesYear = 2013
                <div>
                    <span style="color: #0080ff; font-weight: bold;">&emsp;&emsp;AND</span> SalesPersonID <span style="color: #0080ff; font-weight: bold;">IS NOT NULL</span>
                </div>
                <div style="color: #0080ff; font-weight: bold;">GROUP BY</div> 
                <ul style="margin-left: 2rem;">
                    <li>cte1.SalesPersonID,</li>
        ...
        ), cte3 <span style="color: #0080ff; font-weight: bold;">AS</span>( <span style="color: #7a7a7a;">-- Calculate month over month sales variation per salesperson</span>
            <div style="margin-left: 2rem;">
                <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
                <ul style="margin-left: 2rem;">
                    <li>cte2.SalesPersonID,</li>
                    <li>cte2.MonthNumber,</li>
                    <li>cte2.MonthProduction,</li>
                    <li><span style="color: #0080ff; font-weight: bold;">CASE</span> <span style="color: #7a7a7a;">-- Filter months where growth > 0</span>
                        <div style="margin-left: 2rem;">
                            <span style="color: #0080ff; font-weight: bold;">WHEN</span> ((cte2.MonthProduction / ( <span style="color: #7a7a7a;">-- Using LAG() to retrieve previous value, being current value the default outcome, and apply percentage calculation</span>
                            <div style="margin-left: 2rem;">
                                <span style="color: #6b1cf3;">LAG</span>(cte2.MonthProduction,1,cte2.MonthProduction) <span style="color: #0080ff; font-weight: bold;">OVER</span>(
                                    <div style="margin-left: 2rem;">
                                        <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> cte2.SalesPersonID
                                        <div><span style="color: #0080ff; font-weight: bold;">ORDER BY</span> cte2.MonthNumber</div>
                                    </div>
                                )
                            </div>
                            )) * 100 ) - 100 <= 0 
                            <div><span style="color: #0080ff; font-weight: bold;">THEN</span> 0</div>
                            <div><span style="color: #0080ff; font-weight: bold;">ELSE</span> 1</div>
                            <span style="color: #0080ff; font-weight: bold;">END AS</span> "MOM Variation(%)"
                        </div>
                    </li>
                </ul>
                <span style="color: #0080ff; font-weight: bold;">FROM</span> cte2
            </div>
        ), cte4 <span style="color: #0080ff; font-weight: bold;">AS</span>(
            <div style="margin-left: 2rem;">
                <div style="color: #0080ff; font-weight: bold;">SELECT DISTINCT</div> 
                <div style="margin-left: 2rem;">
                    <div>*,</div>
                    <span style="color: #6b1cf3;">SUM</span>(cte3.[MOM Variation(%)]) <span style="color: #0080ff; font-weight: bold;">OVER</span>(
                        <div style="margin-left: 2rem;">
                            <span style="color: #0080ff; font-weight: bold;">PARTITION BY</span> cte3.SalesPersonID, cte3.[MOM Variation(%)]
                            <div><span style="color: #0080ff; font-weight: bold;">ORDER BY</span> cte3.MonthNumber</div>
                        </div>
                    ) <span style="color: #0080ff; font-weight: bold;">AS</span> Cumulative
                </div>
                <span style="color: #0080ff; font-weight: bold;">FROM</span> cte3
            </div>
        )
        <div style="color: #0080ff; font-weight: bold;">SELECT</div> 
        <div style="margin-left: 2rem;">
            <div><span style="color: #0080ff; font-weight: bold;">DISTINCT</span> cte4.SalesPersonID,</div>
            <div>p.LastName + <span style="color: #a5d6ff;">', '</span> + p.LastName FullName</div>
        </div>
        <span style="color: #0080ff; font-weight: bold;">FROM</span> cte4
        <div>
            <span style="color: #0080ff; font-weight: bold;">JOIN</span> Person.Person p
        </div>
        <div style="margin-left: 2rem;">
            <span style="color: #0080ff; font-weight: bold;">ON</span> cte4.SalesPersonID = p.BusinessEntityID
        </div>
...
<table border="1" class="dataframe table table-striped">
  ...
  <tbody>
    ...
    <tr>
      <td>280</td>
      <td>Ansman-Wolfe, Ansman-Wolfe</td>
    </tr>
    <tr>
      <td>281</td>
      <td>Ito, Ito</td>
    ...
    <tr>
      <td>282</td>
      <td>Saraiva, Saraiva</td>
    </tr>
    <tr>
      <td>283</td>
      <td>Campbell, Campbell</td>
    </tr>
    <tr>
      <td>284</td>
      <td>Mensa-Annan, Mensa-Annan</td>
    </tr>
    <tr>
      <td>286</td>
      <td>Tsoflias, Tsoflias</td>
    </tr>
    <tr>
      <td>287</td>
      <td>Alberts, Alberts</td>
    </tr>
    <tr>
      <td>288</td>
      <td>Valdez, Valdez</td>
    ...
    <tr>
      <td>290</td>
      <td>Varkey Chudukatil, Varkey Chudukatil</td>
    </tr>
  </tbody>
</table>
    `,
